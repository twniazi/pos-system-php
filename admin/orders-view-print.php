...
<div class="text-center py-5">
    <h5>Please provide the Tracking Number</h5>
    <div><a href="orders.php" class="btn btn-primary mt-4 w-25">Go back to orders</a></div>
</div>

<?php
            }
            $orderQuery="SELECT * FROM orders o,customers c WHERE c.id=o.customer_id AND tracking_no='$trackingNo' LIMIT 1";
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <p style="font-size:14px;line-height:20px;margin:0px;padding:0;">Customer Phone Number :<?=$orderDataRow['phone']?></p>
                                            ...
                                            <td align="end">
                                               <h5 style="font-size:20px;line-height:30px;margin:0px;padding:0;">Invoice Details</h5>
                                                ...
                                                <p style="font-size:14px;line-height:20px;margin:0px;padding:0;">Address:1st main road,Banglora,india</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
